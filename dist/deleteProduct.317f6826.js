...
$(document).ready(()=>{
    ...
    const productServivce = new (0, _productServiceDefault.default)((0, _firebaseConstantsDefault.default).RealTimeDB, "Token");
    let choice = confirm("Bạn c\xf3 muốn x\xf3a sản phẩm n\xe0y kh\xf4ng!");
    if (choice == true) productServivce.deleteProduct(id).then((data)=>{
        location.href = "listProducts.html";
    });
    location.href = "listProducts.html";
});

},{"regenerator-runtime/runtime":"dXNgZ","./constants/FirebaseConstants":"ar8Y5","./helpers/UrlHelper":"9C87C","./services/ProductService":"63Op7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9C87C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["luuqc","2ONci"], "2ONci", "parcelRequiref2d3")
