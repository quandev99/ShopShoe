...
$(document).ready(()=>{
    ...
    let choice = confirm("Bạn c\xf3 muốn x\xf3a danh mục n\xe0y kh\xf4ng!");
    if (choice == true) categoryService.deleteCategory(id).then((data)=>{
        location.href = "listCategories.html";
    });
    location.href = "listCategories.html";
});

},{"regenerator-runtime/runtime":"dXNgZ","./services/CategoryService":"1bIMI","./constants/FirebaseConstants":"ar8Y5","./helpers/UrlHelper":"9C87C","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1bIMI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fVD59","kbMaw"], "kbMaw", "parcelRequiref2d3")
