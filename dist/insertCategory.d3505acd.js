...
$(document).ready(()=>{
    $("#save").on("click", ()=>{
        ...
        const name = $("#name").val();
        const cate = new (0, _categoryDefault.default)(null, name);
        const categoryService = new (0, _categoryServiceDefault.default)((0, _firebaseConstantsDefault.default).RealTimeDB, "Token");
        if (name === "") nameError.innerHTML = "Vui l\xf2ng nhập danh mục sản phẩm!";
        else {
            nameError.innerHTML = "";
            try {
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["414Jt","fnxA8"], "fnxA8", "parcelRequiref2d3")
