...
})({"cG9KG":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "c6979d7d3402d96a";
"use strict";
...
},{}],"9SQTH":[function(require,module,exports) {
...
var _orderDetails = require("./models/OrderDetails");
...
for (const huydev of cartItems)list += `
...
$("#addOrder").on("click", ()=>{
    ...
    const orderDetailService = new (0, _orderDetailServiceDefault.default)((0, _firebaseConstantsDefault.default).RealTimeDB, "Token");
    ...
    const orders = new (0, _ordersDefault.default)(null, name, address, email, phone, date, "Th\xe0nh C\xf4ng");
    if (name === "") nameError.innerHTML = "Vui l\xf2ng nhập m\xe3 s\xe1ch";
    else nameError.innerHTML = "";
    if (phone === "") phoneError.innerHTML = "Vui l\xf2ng nhập số điện thoại";
    else if (!isPhone(phone)) phoneError.innerHTML = "Số điện thoại kh\xf4ng đ\xfang định dạng";
    else phoneError.innerHTML = "";
    if (email === "") emailError.innerHTML = "Vui l\xf2ng nhập email";
    else if (!isEmail(email)) emailError.innerHTML = "Email kh\xf4ng đ\xfang định dạng";
    else emailError.innerHTML = "";
    if (address === "") addressError.innerHTML = "Vui l\xf2ng nhập địa chỉ";
    else addressError.innerHTML = "";
    if (name !== "" && phone !== "" && email !== "" && address > 0) try {
        orderService.insertUsers(orders).then((data)=>{
            idOrder.val(data);
            for (const products of cartItems){
                const orderDetail = new (0, _orderDetailsDefault.default)(data, products.productId, products.quantity, products.products.price);
                orderDetailService.insertOrder(orderDetail).then((data)=>{
                    console.log(data);
                });
            }
            window.localStorage.clear();
            alert("Thanh To\xe1n Th\xe0nh C\xf4ng");
...
},{"./constants/FirebaseConstants":"ar8Y5","./services/OrderService":"dPfIm","./services/OrderDetailService":"cQ5Ze","./models/Orders":"aPftK","./models/OrderDetails":"5hoAm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dPfIm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cQ5Ze":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
class OrderDetailService {
    ...
    findById = async (id)=>{
        const res = await (0, _axiosDefault.default).get(`${this.realtimeDb}order_details/${id}.json`);
        return res.data;
    };
    // delete
    deleteProduct = async (id)=>{
        const res = await (0, _axiosDefault.default).delete(`${this.realtimeDb}order_details/${id}.json`);
        return res.data;
    };
}
exports.default = OrderDetailService;

},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aPftK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Orders {
    constructor(id, customer_name, customer_address, customer_email, customer_phone_number, created_date, status){
        this.id = id;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5hoAm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class OrderDetails {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cG9KG","9SQTH"], "9SQTH", "parcelRequiref2d3")

//# sourceMappingURL=checkOrder.3402d96a.js.map
