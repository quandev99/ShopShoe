...
$(document).ready(()=>{
    ...
    $("#save").on("click", ()=>{
        ...
        const product = new (0, _productDefault.default)(categoryIdCtr.val(), null, name, imageCrt, description, price, quantity);
        if (categoryIdCtr.val() == "") categoryIdError.innerHTML = "Vui l\xf2ng chọn danh mục sản phẩm!";
        else categoryIdError.innerHTML = "";
        if (name === "") nameCateError.innerHTML = "Vui l\xf2ng nhập t\xean sản phẩm!";
        else nameCateError.innerHTML = "";
        if (imageCrt === "") imageError.innerHTML = "Vui l\xf2ng tải tệp ảnh l\xean!";
        else imageError.innerHTML = "";
        if (quantity === "") quantityError.innerHTML = "Vui l\xf2ng nhập số lượng!";
        else if (quantity < 1) quantityError.innerHTML = "Số lượng phải lớn hơn 0!";
        else if (!Number(quantity)) quantityError.innerHTML = "Số lượng phải c\xf3 gi\xe1 trị l\xe0 Number!";
        else quantityError.innerHTML = "";
        if (price === "") priceError.innerHTML = "Vui l\xf2ng nhập gi\xe1!";
        else if (price < 0) quantityError.innerHTML = "Gi\xe1 tiền phải lớn hơn 0!";
        else if (!Number(price)) quantityError.innerHTML = "Gi\xe1 tiền phải c\xf3 gi\xe1 trị l\xe0 Number!";
        else priceError.innerHTML = "";
        if (description === "") descriptionError.innerHTML = "Vui l\xf2ng nhập số lượng!";
        else descriptionError.innerHTML = "";
        if (categoryIdCtr !== "" && name !== "" && imageCrt !== "" && quantity !== "" && description !== false) try {
            productService.insertProduct(product).then((data)=>{
                // productIdCtr.val(data)
                alert("Th\xeam sản phẩm th\xe0nh c\xf4ng");
...
},{"regenerator-runtime/runtime":"dXNgZ","./models/Product":"b4We3","./services/ProductService":"63Op7","./services/CategoryService":"1bIMI","./constants/FirebaseConstants":"ar8Y5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"b4We3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["frfQb","g5O8I"], "g5O8I", "parcelRequiref2d3")
