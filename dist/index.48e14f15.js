...
})({"2SYG0":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "8f419d4c48e14f15";
"use strict";
...
},{}],"h2fUh":[function(require,module,exports) {
    ...
    try {
        ...
        productService.findAllProducts().then((data)=>{
            ...
            for(const id in data){
                ...
                if (categoryId === idCategory) productItem += `<li>  
                ...
                `;
                else if (!idCategory) productItem += `<li>  
                <div class="product-item-top">
                    <div class="hot">
                        <p>Hot</p>
                    </div>
            ...
            $("#filter-form").submit(function(event) {
                ...
                if (lowPrice.length == "" || highPrice.length == "") alert("Kh\xf4ng được bỏ trống gi\xe1");
                else if (lowPrice < 0 || highPrice < 0) alert("Gi\xe1 phải lớn hơn > 0");
                else if (lowPrice > highPrice) alert("So s\xe1nh gi\xe1 b\xe9 phải nhỏ hơn so s\xe1nh gi\xe1 lớn!");
                else if (lowPrice && highPrice) filteredData = Object.values(data).filter((products)=>products.price >= lowPrice && products.price <= highPrice);
                listProduct.empty();
...
},{"regenerator-runtime/runtime":"dXNgZ","./constants/FirebaseConstants":"ar8Y5","./helpers/UrlHelper":"9C87C","./services/CategoryService":"1bIMI","./services/ProductService":"63Op7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9C87C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2SYG0","h2fUh"], "h2fUh", "parcelRequiref2d3")

//# sourceMappingURL=index.48e14f15.js.map
